...
import { initialReusableProcessingFormState } from "@/lib/laundry/forms/transactions";
import type { ReturnTransactionSessionDetail } from "@/lib/laundry/services/return-processing-read-models";
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <input
                        type="hidden"
                        name="notes"
                        value={`Proses reusable dari Area Pencucian (Ref: ${session.referenceNo || 'Return'})`}
                      />
                      <div className="grid gap-1.5">
                        <label
