...
drop policy if exists "laundry_items_select_user" on public.laundry_items;
drop policy if exists "laundry_stock_balances_select_user" on public.laundry_stock_balances;
drop policy if exists "laundry_stock_movements_select_user" on public.laundry_stock_movements;
drop policy if exists "laundry_units_of_measure_select_user" on public.laundry_units_of_measure;
drop policy if exists "laundry_hospital_units_select_user" on public.laundry_hospital_units;
